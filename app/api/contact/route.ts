...
export async function POST(req: NextRequest) {
  try {
    ...
    // Send notification to Navale
    await resend.emails.send({
      from: 'Website Navale <noreply@yourdomain.com>', // Ganti dengan domain Anda
      to: ['cv.navalemitratama@gmail.com'],
      replyTo: email,
      subject: `[Website] Pesan baru dari ${name} — ${service}`,
      html: `
    ...
    await resend.emails.send({
      from: 'CV Navale Mitratama <noreply@yourdomain.com>', // Ganti dengan domain Anda
      to: [email],
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f8fafc; padding: 20px;">
          ...
          <div style="background: white; padding: 32px;">
            <p style="color: #1A2535; font-size: 16px;">Halo <strong>${name}</strong>,</p>
            <p style="color: #4B5563; line-height: 1.7;">
              Terima kasih telah menghubungi CV Navale Mitratama. Pesan Anda mengenai 
              <strong style="color: #1A56A0;">${service}</strong> telah kami terima.
            </p>
            <p style="color: #4B5563; line-height: 1.7;">
            ...
            <a href="https://wa.me/6281219445330" style="display: inline-block; background: #25D366; color: white; padding: 12px 24px; text-decoration: none; font-weight: 600; margin-bottom: 24px;">
